...
import REMOVE_JACK_HEART from '../../assets/cards/jack_of_hearts2.png';
import REMOVE_JACK_SPADE from '../../assets/cards/jack_of_spades2.png';
...
export const cardMap: Record<string, string> = {
  ...
  TenOfS: TenOfS,
  BlackJ: BlackJ,
  REMOVE_JACK_HEART: REMOVE_JACK_HEART,
  REMOVE_JACK_SPADE: REMOVE_JACK_SPADE,
  WILD_JACK_DIAMOND: WILD_JACK_DIAMOND,
  WILD_JACK_CLUB: WILD_JACK_CLUB,
};
